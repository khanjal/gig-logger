...
def add_lambda_permissions(function_name):
    try:
        lambda_commands = [
            ...
            # "aws lambda add-permission --function-name {function-name} --source-arn arn:aws:execute-api:us-east-1:***REMOVED***:1al1hr5ub4/*/POST/sheets/save --principal apigateway.amazonaws.com --statement-id {statement-id} --action lambda:InvokeFunction",
