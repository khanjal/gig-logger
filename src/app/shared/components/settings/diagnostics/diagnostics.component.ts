...
@Component({
  ...
  standalone: true,
  imports: [MatCardModule, MatListModule, MatIconModule, BaseRectButtonComponent],
...
export class DiagnosticsComponent implements OnInit {
  ...
  private async checkDataIntegrity() {
    ...
    const names = await this._nameService.list();    // Check for duplicate shifts
    ...
    this._logger.debug('Empty shifts found:', emptyShifts); this.dataDiagnostics.push({
      name: 'Empty Shifts',
    ...
    this._logger.debug('Orphaned trips found:', orphanedTrips); this.dataDiagnostics.push({
      name: 'Orphaned Trips',
